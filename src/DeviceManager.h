...
public:
    explicit DeviceManager(bool daemon = false, const QString &primaryAdapterName = QString());
    ~DeviceManager();
...
private:
    QString m_selectedAdapterName;

public:
    void setSelectedAdapterName(const QString &name);
    QStringList getAvailableAdapterNames() const;
};
